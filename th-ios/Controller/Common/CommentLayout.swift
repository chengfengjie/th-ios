...
class CommentCellNode: ASCellNode, CommentCellNodeLayout {
    ...
    override init() {
        ...
        self.reportButtonNode.setAttributedTitle("举报".withFont(Font.sys(size: 12)).withTextColor(Color.color6),
                                                for: UIControlState.normal)
        
        self.replyButtonNode.setAttributedTitle("回复".withFont(Font.sys(size: 12)).withTextColor(Color.color6),
                                                for: UIControlState.normal)
    }
